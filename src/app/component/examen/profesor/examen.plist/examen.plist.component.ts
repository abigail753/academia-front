...
export class ProfExamenPlistComponent implements OnInit {
  ...
  create() {
    this.oRouter.navigate(['profesor/examen/create']);
  }
  view(oExamen: IExamen) {
    this.oRouter.navigate(['profesor/examen/view', oExamen.id]);
  }
